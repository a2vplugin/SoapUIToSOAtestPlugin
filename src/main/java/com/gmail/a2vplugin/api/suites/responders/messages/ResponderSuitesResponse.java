...
@XmlType(name = "responderSuitesResponse", propOrder = { "id", "name", "referenceLocation", "referenced",
        "relationships", "requirementsAndNotes", "url" })
public class ResponderSuitesResponse {
